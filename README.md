...
### Вторая версия
Чтобы узнать, как можно ускорить поиск слова, я создал профили программы при помощи инструментов Perf и Valgrind (см. Приложение Б). По ним я определил, что наибольшее время уходит на сравнение слов функцией strcmp.
