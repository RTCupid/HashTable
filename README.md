...
В результате ассемблерных оптимизаций получено ускорение поиска слов в хэш-таблице на 96 %.
...
В конце я определил по профилю perf, что дальнейшие ассемблерные оптимизации не дадут прироста более, чем на 1 % по отношению к имеющемуся коду, поэтому решил остановиться в оптимизациях. Итогом ассемблерных оптимизаций стало ускорение поиска слов в хэш-таблице на 96 %.
